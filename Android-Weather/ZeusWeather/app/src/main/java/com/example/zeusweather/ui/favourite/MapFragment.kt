...
import com.example.zeusweather.databinding.FragmentMapsBinding
...
class MapFragment : Fragment(), GoogleMap.OnMapClickListener {
    ...
    override fun onCreateView(
        ...
        binding.searchImageView.setOnClickListener() {
            if (!Places.isInitialized()) {
                Places.initialize(requireContext(), getString(R.string.api_map), Locale.US)
            }
    ...
    private fun showDialogForLocation(latLng: LatLng) {
        ...
        alertDialogBuilder.setTitle(getString(R.string.select_location))
        alertDialogBuilder.setMessage(getString(R.string.do_you_location))
